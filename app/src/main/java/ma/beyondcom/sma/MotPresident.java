...
public class MotPresident extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(ma.beyondcom.sma.R.layout.activity_mot_president);
        ...
        webView.loadUrl("http://printempsdecardiologie.ma/smaandroid/mp.php");
    }
    @Override
