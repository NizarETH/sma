...
public class Programmeinf extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(ma.beyondcom.sma.R.layout.activity_programmeinf);
        ...
        webView.loadUrl("http://beyondcom.ma/smaandroid/proginf.php");
    }
    @Override
